...
import {
  ...
  type CategoryItem, type StepItem,
} from "./mockData";
    ...
    <div className="space-y-2">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          <button onClick={() => navigate("/")} className="p-1 rounded hover:bg-accent">
        ...
        <div className="flex items-center gap-2">
          ...
          <button className="flex items-center gap-1 px-3 py-1.5 bg-blue-600 text-white rounded hover:bg-blue-700 text-sm">
