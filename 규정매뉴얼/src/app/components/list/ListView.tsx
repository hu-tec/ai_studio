...
import { LargeCategory, Regulation, CATEGORY_TYPES } from '../../data/mockData';
import { 
  Search, 
  ChevronRight, 
  ChevronDown, 
...
import { OnOFFToggle, PillButton } from '../common/RegulationControls';
...
function RegulationBox({ regulation, isExpanded, prefix, onUpdate, onDelete, onToggleSelect, isSelected, actionMode }: { 
  ...
  // These internal states should ideally be in the Regulation object for persistence, 
  // but for immediate interactivity we sync them with the regulation object's content and dummy properties
