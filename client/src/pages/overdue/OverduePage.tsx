                ...
                {(mode === 'add' || mode === 'edit') && (
                  <div className="flex gap-2">
                    <button
                      ...
                      className="px-2 py-1.5 bg-slate-100 hover:bg-slate-200 text-slate-600 rounded-lg text-sm font-medium transition-colors"
                    >
                      취소
                    </button>
                    <button
                      onClick={handleSave}
                      className="px-2 py-1.5 bg-slate-800 hover:bg-slate-900 text-white rounded-lg text-sm font-medium shadow-sm transition-colors"
                    >
                      저장하기
                    </button>
                  </div>
                        ...
                        <div>
                          ...
                          <div className="text-xs font-bold text-slate-800">
                            {mode === 'add' || mode === 'edit' ? (
                              <input
                                type="number"
                                className="bg-white border border-slate-200 rounded px-2 py-1 w-full text-sm"
            ...
            <div className="bg-white w-full max-w-2xl rounded-md shadow-sm overflow-hidden animate-in fade-in zoom-in duration-200">
              <div className="p-2 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
                <div className="flex items-center gap-1">
                  ...
                  <div>
                    <h3 className="text-sm font-bold text-slate-800">{data.find(d => d.id === previewId)?.name} 님의 상세 정보</h3>
