/* 원본: hutechc_hompage_real/app/(client-layout)/exhibition/upload/page.tsx */
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
        ...
        <section className="bg-white border rounded-xl p-4 space-y-4 text-xs md:text-sm">
          ...
          <div className="flex justify-end gap-2 pt-4 border-t mt-2 text-xs">
            ...
            <Link to="/hutechc-homepage/exhibition/list" className="border rounded px-4 py-1 hover:bg-gray-50 text-center">
              목록
            </Link>
