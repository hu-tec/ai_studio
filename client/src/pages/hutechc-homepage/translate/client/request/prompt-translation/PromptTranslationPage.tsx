/* 원본: hutechc_hompage_real/app/translate/client/request/prompt-translation/page.tsx */
...
export default function PromptTranslationPage() {
  ...
  const handleSubmit = () => {
    ...
    navigate("/hutechc-homepage/translate/client/requests");
  };
