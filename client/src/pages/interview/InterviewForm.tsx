...
function ScoreSelector({ label, value, onChange }: { label: string; value: number; onChange: (v: number) => void }) {
  return (
    <div>
      <label className="text-gray-600 block mb-0.5" style={{ fontSize: "0.7rem" }}>{label}</label>
...
const labelStyle = { fontSize: "0.7rem" as const };
const inputStyle = { fontSize: "0.76rem" as const };
      ...
      <div className="flex-1 min-w-0 overflow-y-auto">
        <div className="space-y-2 pb-4">
          ...
          {editingId && (
            <button
              onClick={handleNew}
              className="flex items-center gap-1.5 px-3 py-1 bg-indigo-50 text-indigo-600 rounded-lg hover:bg-indigo-100 transition-colors"
          ...
          {/* Pass Status Bar */}
          <div className="flex items-center justify-between bg-white rounded-lg border border-gray-100 px-3 py-1.5">
            <div className="flex items-center gap-2">
            ...
            <div className="flex gap-1">
              {([
                ...
                <button
                  ...
                  className={`px-2.5 py-1 rounded-lg border-2 transition-all ${
            ...
            <div className="grid grid-cols-4 gap-2">
              ...
              <div className="bg-white rounded-lg border border-gray-100 p-2.5 space-y-1.5">
                ...
                <div>
                  ...
                  <div className="min-h-[24px] border border-gray-100 rounded-md px-2 py-1 bg-gray-50">
          ...
          <div className="bg-white rounded-lg border border-gray-100 overflow-hidden">
            <button
              ...
              className="w-full flex items-center justify-between px-3 py-1.5 bg-indigo-50/60 hover:bg-indigo-50 transition-colors"
            >
          ...
          <button
            onClick={handleSave}
            className="w-full flex items-center justify-center gap-2 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors shadow-sm"
