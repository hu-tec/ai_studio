...
/* ═══ 바로가기 데이터 (ShortcutsPage 원본 완전 이관) ═══ */
const SHORTCUT_GROUPS = [
  ...
  { title: 'A.데이터 (Figma)', emoji: '📊', color: '#7C3AED', bg: '#F5F3FF', links: [
    { name: '감사처리(강사커리)', url: 'https://www.figma.com/make/60eyAaz66uEvV18k3WWbNS/' },
    ...
    { name: '문제은행 사이트', url: 'https://www.figma.com/make/cRwrhKVBI5U9iSTopaS1DB/' },
    { name: 'DB', url: 'https://www.figma.com/make/Vxx6ETPoYGEr5R6Ue754Qa/' },
    { name: 'DB v2', url: 'https://www.figma.com/make/uGCONfLFy7YzzZEbu1yiQQ/' },
  ]},
  { title: 'B.관리자 (Figma)', emoji: '🔐', color: '#DC2626', bg: '#FEF2F2', links: [
    ...
    { name: '바로가기 페이지', url: 'https://www.figma.com/make/eHP8SI0rLMYd5IUmZgHiHa/' },
    { name: '랜딩페이지 관리', url: 'https://www.figma.com/make/Fn89JyeeaizgKWgdZgKnvg/' },
  ]},
  { title: 'C.사용자 (Figma)', emoji: '👤', color: '#0EA5E9', bg: '#F0F9FF', links: [
    ...
    { name: '휴텍씨 서비스소개', url: 'https://www.figma.com/make/0nGaGvepD5B0K70TAj4NUd/' },
  ]},
  { title: 'D.전문가/E.개별 (Figma)', emoji: '📄', color: '#F59E0B', bg: '#FFFBEB', links: [
  ...
  { title: 'F.UIUX/G.매뉴얼/H.그외', emoji: '🎨', color: '#EC4899', bg: '#FDF2F8', links: [
    { name: 'TESOL UIUX (이사님)', url: 'https://www.figma.com/make/kWloAMfn7fpvjGuP8HexYe/' },
  ...
  { title: '개별홈페이지 (Figma)', emoji: '🚀', color: '#6366F1', bg: '#EEF2FF', links: [
    { name: '대표님홈페이지 v3', url: 'https://www.figma.com/make/UitESewEV8DEcjURgkVKxX/' },
    { name: '휴텍씨홈페이지 v4', url: 'https://www.figma.com/make/SOZJUzzTnX6RtPnfCQaxcb/' },
    { name: '번역전체', url: 'https://www.figma.com/make/0nGaGvepD5B0K70TAj4NUd/' },
    { name: '번역_고전문서', url: 'https://www.figma.com/make/22oZmCgsA0nQk0YNizokPS/' },
  ...
  { title: '데이터시스템 (Figma)', emoji: '🗄️', color: '#475569', bg: '#F8FAFC', links: [
    { name: 'AI STUDIO v3', url: 'https://www.figma.com/make/cT4lO1pvdmRev3J9EwSnxZ/' },
    { name: '신청서관리 v3', url: 'https://www.figma.com/make/BaLDHmzgYewuB67ix69efj/' },
    { name: '강의시간표_신청', url: 'https://www.figma.com/make/m2bQEhHLuobcGWtAM6IM4G/' },
    ...
    { name: '업무일지 v3', url: 'https://www.figma.com/make/PWBXhOKfRhCpe1PCN4Zvbf/' },
    ...
    { name: '상담관리시스템 v3', url: 'https://www.figma.com/make/gP07Sq3qQGcMJRMk3oKt9p/' },
    { name: '사진모음대시보드 v3', url: 'https://www.figma.com/make/d8wm1SkBtFMdXHkDvgXZA5/' },
    { name: '미팅신청폼', url: 'https://www.figma.com/make/RNBVN2MX8sO8K1CCUuzFp7/' },
    { name: '거래처_아웃콜', url: 'https://www.figma.com/make/SSWXLtj7Y3Qv1kqXMfKPI5/' },
    { name: '미수금관리', url: 'https://www.figma.com/make/7C5JNg2oE9bAj8KnkRA9Al/' },
    { name: '관리자통합 v3', url: 'https://www.figma.com/make/kowZcVk9PeKVCrnGd3AG2Y/' },
    { name: '서약서', url: 'https://www.figma.com/make/G8KgWb7BpmxtGNbUhAP1gQ/' },
    { name: '출퇴근관리', url: 'https://www.figma.com/make/SwVqROPmC9bwqY7ZawKODO/' },
    { name: '평가기준설정', url: 'https://www.figma.com/make/hwQ9CKSdzmuTZQtIDgI737/' },
    { name: '사내업무지침 v1', url: 'https://www.figma.com/make/zNW5hljdQR9ERzmtIxOuyc/' },
  ]},
  { title: '출력용 (Figma)', emoji: '🖨️', color: '#94a3b8', bg: '#F1F5F9', links: [
    { name: '출력_면접관리 v4', url: 'https://www.figma.com/make/LRPaDtZ0fQPWMEcMcg9pUM/' },
    { name: '출력_강사지원자 v2', url: 'https://www.figma.com/make/IMQ5j738rY41AXhUc8om55/' },
    { name: '출력_전문가지원 v2', url: 'https://www.figma.com/make/W6ualQ72O2HrqWORKZqZfq/' },
    { name: '출력_번역가지원 v2', url: 'https://www.figma.com/make/P2DFSE1YZS42rcbVXucbS1/' },
    { name: '출력_강사면접플로우', url: 'https://www.figma.com/make/VyYeBtOudiFDJewI5hjL0B/' },
  ]},
