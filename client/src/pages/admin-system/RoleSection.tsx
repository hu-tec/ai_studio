...
export const RoleSection: React.FC = () => {
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="bg-white border border-zinc-200 rounded-lg p-6 shadow-sm space-y-8 h-full">
        <div>
          <label className="block text-[10px] font-black text-zinc-400 mb-6 uppercase tracking-widest border-b border-zinc-100 pb-1">역할 템플릿 👤</label>
          <div className="grid grid-cols-1 gap-4">
            <div className="bg-zinc-50/50 p-5 border border-zinc-200 rounded-lg hover:border-zinc-900 transition-colors group">
            ...
            <div className="bg-zinc-50/30 p-5 border border-zinc-100 rounded-lg opacity-40 grayscale">
        ...
        <div>
          <label className="block text-[10px] font-black text-zinc-400 mb-6 uppercase tracking-widest border-b border-zinc-100 pb-1">권한 가이드 🔐</label>
          <div className="space-y-3">
            {[
              ...
              <div key={role.title} className="flex justify-between items-center p-4 bg-white border border-zinc-100 rounded-lg hover:border-zinc-200 hover:shadow-sm transition-all group">
