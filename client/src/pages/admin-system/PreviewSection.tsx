  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="bg-white border border-zinc-200 rounded-lg p-2 shadow-sm h-full flex flex-col">
        ...
        <div className="bg-zinc-50 border border-zinc-200 rounded-md p-2 mb-1">
          <p className="text-[10px] font-bold text-zinc-400 mb-1 uppercase tracking-widest">미리보기</p>
