...
export const PreviewSection: React.FC = () => {
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="bg-white border border-zinc-200 rounded-lg p-6 shadow-sm h-full flex flex-col">
        <div className="mb-8">
          <h3 className="text-sm font-black text-zinc-900 mb-4">필수 항목(화면 고정)</h3>
