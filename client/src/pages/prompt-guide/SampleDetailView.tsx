  ...
  return (
    <div className="max-w-6xl mx-auto space-y-3 pb-20 p-3">
      ...
      <section className="space-y-4">
        ...
        >
          <span className="px-3 py-1 bg-neutral-100 text-neutral-800 text-xs font-bold tracking-wider uppercase rounded-full">
            {sample.category}
          </span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 items-start">
        ...
        <section className="space-y-3 sticky top-24">
          ...
          <motion.div
            ...
            className="group relative bg-white border border-neutral-200 rounded-3xl overflow-hidden shadow-2xl shadow-neutral-900/5 ring-1 ring-neutral-100"
          >
            <img
              src={sample.imageUrl}
              alt="최종 결과물"
