...
export function AddSampleModal({ isOpen, onClose }: AddSampleModalProps) {
  ...
  return (
    <AnimatePresence>
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-2 md:p-1">
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
          ...
          <motion.div
            ...
            className="relative w-full max-w-6xl max-h-[90vh] bg-[#f8f9fa] rounded-[40px] shadow-sm overflow-hidden flex flex-col border border-white/20"
          >
            {/* Modal Header */}
            <div className="flex items-center justify-between px-2 py-1 bg-white border-b border-neutral-100">
              <div className="flex items-center gap-2">
                <div className="w-12 h-12 bg-neutral-900 rounded-md flex items-center justify-center text-white shadow-sm">
                  <PlusCircle size={24} />
                </div>
                <div>
              ...
              <div className="flex items-center gap-1">
                <button
                  onClick={onClose}
                  className="p-1 text-neutral-400 hover:text-neutral-900 hover:bg-neutral-100 rounded-md transition-all"
                >
                  <X size={24} />
                </button>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-1">
                ...
                <section className="space-y-1">
                  <div className="flex items-center gap-1 text-neutral-900">
                    <div className="p-2.5 bg-white rounded-md shadow-sm border border-neutral-100">
                  ...
                  <div className="space-y-2">
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        className="w-full px-2 py-1 bg-white border border-neutral-200 rounded-md text-sm focus:ring-4 focus:ring-neutral-100 outline-none transition-all font-bold placeholder:text-neutral-300 shadow-sm"
                      />
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <div className="space-y-2">
                        ...
                        <select
                          ...
                          className="w-full px-2 py-1 bg-white border border-neutral-200 rounded-md text-sm focus:ring-4 focus:ring-neutral-100 outline-none transition-all font-bold text-neutral-700 shadow-sm"
                        >
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="w-full px-2 py-1 bg-neutral-100 border border-neutral-100 rounded-md text-sm text-neutral-400 flex items-center gap-2 font-bold shadow-inner">
                          <Calendar size={16} /> {new Date().toISOString().split('T')[0]}
                        </div>
                      </div>
                    </div>

                    <div className="relative space-y-1 pt-2 before:absolute before:left-4 before:top-6 before:bottom-6 before:w-[2px] before:bg-neutral-200/50">
                      {/* Primary Prompt */}
                      <div className="relative pl-2">
                        <div className="absolute left-0 top-0 w-8 h-8 rounded-full bg-neutral-900 flex items-center justify-center text-white text-[10px] font-bold shadow-sm shadow-neutral-200 z-10">
                          1
                        </div>
                        <div className="space-y-2">
                          ...
                          <textarea
                            ...
                            rows={4}
                            className="w-full px-2 py-1 bg-white border border-neutral-200 rounded-md text-sm focus:ring-4 focus:ring-neutral-100 outline-none transition-all leading-relaxed placeholder:text-neutral-300 shadow-sm"
                          />
                        </div>
                      </div>
                        ...
                        <div key={idx} className="relative pl-2">
                          ...
                          <div className="space-y-2 group">
                            ...
                            <textarea
                              ...
                              rows={2}
                              className="w-full px-2 py-1 bg-neutral-50 border border-neutral-100 rounded-md text-sm focus:ring-4 focus:ring-neutral-100 outline-none transition-all leading-relaxed italic placeholder:text-neutral-300"
                            />
                          </div>
                        </div>
                      ))}
                      ...
                      <div className="pl-2">
                        <button
                          ...
                          className="flex items-center gap-2 px-2 py-1.5 bg-white hover:bg-neutral-50 text-neutral-500 hover:text-neutral-900 rounded-md text-xs font-bold transition-all border-2 border-dashed border-neutral-200 shadow-sm"
                        >
                ...
                <section className="space-y-1">
                  ...
                  <div className="space-y-1">
                    <div className="aspect-[4/3] relative rounded-[32px] overflow-hidden border-2 border-dashed border-neutral-200 bg-white group hover:border-neutral-400 transition-all duration-500 flex flex-col items-center justify-center text-center p-1 shadow-sm">
                      {imageUrl ? (
                        <>
                          ...
                          <div className="absolute inset-0 bg-neutral-900/60 opacity-0 group-hover:opacity-100 transition-all flex items-center justify-center backdrop-blur-[2px]">
                            <button
                              onClick={() => setImageUrl('')}
                              className="px-2 py-1 bg-white text-neutral-900 rounded-md text-xs font-bold shadow-sm hover:bg-neutral-100 transition-colors"
                            >
                              이미지 변경하기
                            </button>
                          </div>
                        ...
                        <>
                          <div className="p-2 bg-neutral-50 rounded-md text-neutral-300 mb-2 group-hover:scale-110 transition-transform duration-500 border border-neutral-100">
                            <ImageIcon size={40} />
                          </div>
                    ...
                    <div className="bg-neutral-900 rounded-[32px] p-1 text-white space-y-2 relative overflow-hidden shadow-sm">
                      <div className="absolute top-0 right-0 w-40 h-40 bg-white/5 rounded-full -mr-2 -mt-2 blur-3xl" />
                      <div className="absolute bottom-0 left-0 w-32 h-32 bg-indigo-500/10 rounded-full -ml-2 -mb-1 blur-3xl" />
                      <div className="relative z-10 space-y-1">
                        ...
                        <div className="grid grid-cols-2 gap-1 pt-2">
                          <div className="px-2 py-1 bg-white/5 rounded-md border border-white/5 text-[10px] font-bold text-neutral-300 flex items-center gap-2">
            ...
            {/* Modal Footer */}
            <div className="px-2 py-1 bg-white border-t border-neutral-100 flex items-center justify-end gap-1">
              <button
                onClick={onClose}
                className="px-2 py-1 text-sm font-bold text-neutral-500 hover:text-neutral-900 transition-colors"
              >
                취소
              </button>
              <button
                onClick={handleSave}
                className="px-2 py-1.5 bg-neutral-900 text-white rounded-md font-bold flex items-center gap-2 hover:bg-neutral-800 transition-all shadow-sm shadow-neutral-200 active:scale-95"
              >
